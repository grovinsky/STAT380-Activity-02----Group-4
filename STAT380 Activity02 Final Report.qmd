...
There appear to be three levels of charges represented on this plot. The majority of insurance holders have charges ranging from $1100 to $20000. We can see the increasing linear relationship between age and insurance charges.
```{r}
#| echo: false
